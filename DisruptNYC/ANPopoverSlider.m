...
-(id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.value = .6;
        [self setValue:.6 animated:YES];
        [self fadePopupViewInAndOut:NO];
        //self.thumbRect = CGRectMake(130, 22, 50, 50);
        //[self beginTrackingWithTouch:[UITouch alloc] in CGPointMake(130, 22) withEvent:UITouchPhaseBegan];
    }
    return self;
}
...
-(void)positionAndUpdatePopupView {
    ...
    CGRect popupRect = CGRectOffset(zeThumbRect, 5, -floor(zeThumbRect.size.height * 1.5));
